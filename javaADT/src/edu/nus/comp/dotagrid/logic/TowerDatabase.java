...
public class TowerDatabase {
	...
	public TowerDatabase(){
		...
		*/
		...
		Tower scourgeTower1 = new Tower("Scourge Tower 1", 250, 1300, 0, 120, 5, 1.0, 18, 50, -522, 50);
		scourgeTower1.setCharacterImage("towers", "Scourge Tower");
		Tower scourgeTower2 = new Tower("Scourge Tower 2", 300, 1600, 0, 140, 5, 1.0, 18, 60, -522, 50);
		scourgeTower2.setCharacterImage("towers", "Scourge Tower");	
		Tower scourgeTower3 = new Tower("Scourge Tower 3", 350,  1600, 0, 180, 5, 1.0, 25, 70, -522, 50);
		scourgeTower3.setCharacterImage("towers", "Scourge Tower");
		Tower scourgeTower4 = new Tower("Scourge Tower 4", 400, 1600, 0, 180, 5, 1.0, 30, 80, -522, 50);
