...
public class Hero extends Character{
	...
	// changed to key:value structure
	// reason: array indices are not persistent in the game play
	// simple java array is not flexible when new skills are learnt
	...
	public void addItem(Item item){
		items.put(item.getItemName(), new Item(item));
	}
